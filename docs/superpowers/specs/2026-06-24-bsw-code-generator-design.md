...
> **Date**: 2026-06-24
> **Target**: v1.10.0 MINOR (next feature slot; v1.9.0/v1.9.1 already WIP on
> `feature/v1-9-1-ecucdefs-fold` and not yet on `main`)
...
> **Branch base**: current `main` (v1.8.5 SHIPPED at `fff92a5`)
