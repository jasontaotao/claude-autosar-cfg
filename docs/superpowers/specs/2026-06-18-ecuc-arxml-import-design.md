...
export type ImportPatchOp =
  ...
  | { readonly kind: 'merge-into-module'; readonly moduleShortName: string; readonly additions: ArxmlContainer[] }
  | { readonly kind: 'overwrite-module'; readonly moduleShortName: string; readonly replacement: ArxmlModule }
  | { readonly kind: 'rename-incoming'; readonly originalShortName: string; readonly newShortName: string };
```
...
export type ImportError =
  ...
  | { readonly kind: 'patch-apply-failed'; readonly sourceFile: string; readonly moduleShortName: string; readonly message: string }
  | { readonly kind: 'multiplicity-exceeded'; readonly sourceFile: string; readonly containerPath: string; readonly limit: number }
  | { readonly kind: 'no-modules-selected' }
  | { readonly kind: 'view-mode-locked'; readonly currentViewMode: 'import-merged' }
  | { readonly kind: 'mixed-versions'; readonly targetVersion: string; readonly incomingVersions: readonly string[] };
```
