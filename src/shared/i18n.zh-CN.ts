...
export const MessagesZhCN: Messages = {
  ...
  // v1.22.0 T2 — OdxViewer read-only modal labels. 3 tabs (DTC /
  // DID / Routine) mirror the v1.21.0 T4 DBC viewer but expose a
  // different domain surface (diagnostic metadata vs CAN frames).
