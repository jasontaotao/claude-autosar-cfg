...
const a: BswModuleDef = { shortName: 'A', path: '/A', containers: [], parameters: [], references: [] } as BswModuleDef;
const b: BswModuleDef = { shortName: 'B', path: '/B', containers: [], parameters: [], references: [] } as BswModuleDef;
const c: BswModuleDef = { shortName: 'C', path: '/C', containers: [], parameters: [], references: [] } as BswModuleDef;
