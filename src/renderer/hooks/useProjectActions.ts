...
// v1.18.5 PATCH — extracted module-level helpers + types live in the
// subdir; re-imported here. The parent file stays the public entry
// point for callers (no barrel re-export added).
import { guardedDirtySwitch, setNewProjectDialogOpen } from './useProjectActions/helpers.js';
import type { ProjectActionResult } from './useProjectActions/types.js';
