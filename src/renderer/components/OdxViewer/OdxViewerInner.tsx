// OdxViewerInner — P2 (spec §4.1) split: the original viewer
// implementation, extracted verbatim so OdxViewer can be wrapped in
...
export interface OdxViewerInnerProps {
...
export function OdxViewerInner({
  open,
  path,
  summary,
  error,
  ...
  onExport,
  exporting,
}: OdxViewerInnerProps): JSX.Element | null {
